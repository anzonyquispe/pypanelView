...
library(dplyr)
library(ggplot2)
setwd( '/Users/ar8787/Documents/GitHub/panelView' )
load("data/panelView.RData")
ls()
fwrite(capacity, '/Users/ar8787/Documents/GitHub/pypanelView/capacity.csv')

setwd( '/Users/ar8787/Documents/GitHub/pypanelView' )
Y = NULL
D = NULL
X = NULL
ignore.treat = FALSE
...
capacity = fread("capacity.csv")
# formula = formula(turnout ~ policy_edr + policy_mail_in + policy_motor, )
# color = c("#B0C4DE","white")
# by.timing = TRUE
# index = c("abb","year")
# xlab = "Year"
# ylab = "State"
...
data <- capacity
formula = formula('Capacity ~ demo + lnpop + lngdp')
data = capacity
index = c("ccode", "year") 
axis.lab.gap = c(2,0)
main = "Democracy and State Capacity"
id = unique(capacity$ccode)[26:50]
by.timing = TRUE
